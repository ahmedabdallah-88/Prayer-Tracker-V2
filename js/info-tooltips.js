...
window.App.InfoTooltips = (function() {
    ...
    var descriptions = {
        1:  { ar: 'الحلقة الخضراء = نسبة الصلوات اللي صليتها من إجمالي السنة. الحلقة الذهبية = نسبة صلاة الجماعة من اللي صليته. كل ما الحلقة تكمل يبقى أداؤك أفضل.',
              en: 'Green ring = percentage of prayers you performed this year. Gold ring = percentage prayed in congregation out of what you prayed. Fuller rings mean better performance.' },
        ...
        4:  { ar: 'كل شهر هجري ليه نقطة. الخط الأخضر = نسبة الإنجاز الكلي. الخط الذهبي المقطع = نسبة الجماعة. كل ما الخط يعلى يبقى الشهر أحسن.',
              en: 'Each Hijri month has a data point. Green line = overall completion. Dashed gold line = congregation rate. Higher lines mean better months.' },
        5:  { ar: 'بيقارن أداء كل صلاة من الخمس. الشريط الأخضر = نسبة الإنجاز. الشريط الذهبي = نسبة الجماعة. تقدر تعرف أنهي صلاة محتاج تحسنها.',
              en: 'Compares each of the 5 prayers. Green bar = completion rate. Gold bar = congregation rate. Identify which prayer needs improvement.' },
        6:  { ar: 'بيوضح أي يوم في الأسبوع بتصلي فيه جماعة أكتر. مرتب من الأعلى للأقل. أخضر غامق = ممتاز (٩٠٪+)، ذهبي = متوسط، أحمر = ضعيف.',
              en: 'Shows which weekday you pray in congregation the most. Sorted highest to lowest. Dark green = excellent (90%+), gold = average, red = weak.' },
        ...
        10: { ar: 'بيقارن أداء كل صلاة سنة. تقدر تعرف أنهي سنة بتحافظ عليها وأنهي محتاج تزودها.',
              en: 'Compares each sunnah prayer performance. See which ones you maintain and which need more attention.' },
        ...
        12: { ar: 'بيوضح عدد أيام الصيام في رمضان. الأيام الخضراء = صمت. الحمراء = فاتت. البنفسجية = إعفاء (للنساء). المتبقي = أيام لسه ما جاتش.',
              en: 'Shows Ramadan fasting days. Green = fasted. Red = missed. Purple = exemption (females). Remaining = upcoming days.' },
        ...
        15: { ar: 'كل بطاقة = شهر هجري. النسبة = إنجازك في الشهر. اللون الأخضر = ممتاز، الذهبي = جيد، الأحمر = ضعيف. اضغط على أي شهر للتفاصيل.',
              en: 'Each card = one Hijri month. Percentage = your monthly performance. Green = excellent, gold = good, red = weak. Tap any month for details.' },
        16: { ar: 'بيوضح أيام الإعفاء (الحيض أو النفاس). الأيام البنفسجية مش بتتحسب في نسبة الإنجاز — يعني مش بتأثر على إحصائياتك.',
              en: 'Shows exemption days (menstruation or postpartum). Purple days are excluded from completion calculations — they don\'t affect your stats.' },
    ...
    function initStaticButtons() {
        ...
        // 3. Sunnah Streak Flame (same description as fard streak)
        addToChartCard('sunnahStreakFlame', 3);
        // 4. Sunnah Mountain Chart
        addToChartCard('sunnahMountainChart', 4);
