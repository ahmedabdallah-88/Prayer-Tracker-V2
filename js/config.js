...
window.App.Config = {
    ...
    T: {
        ...
        // Qada Calculator
        'qada_calculator': { ar: 'حاسبة القضاء', en: 'Qada Calculator' },
        'qada_calculator_sub': { ar: 'احسب صلوات القضاء وضع خطة', en: 'Calculate missed prayers and create a plan' },
        'qada_edit_plan': { ar: 'تعديل خطة القضاء', en: 'Edit Qada Plan' },
        'qada_step': { ar: 'الخطوة', en: 'Step' },
        'qada_of': { ar: 'من', en: 'of' },
        'qada_step1_title': { ar: 'بيانات القضاء', en: 'Qada Data Entry' },
        'qada_step2_title': { ar: 'خطة القضاء', en: 'Qada Plan' },
        'qada_step3_title': { ar: 'تأكيد الخطة', en: 'Confirm Plan' },
        'qada_puberty_date': { ar: 'تاريخ البلوغ', en: 'Date of puberty' },
        'qada_regular_date': { ar: 'تاريخ بداية الانتظام', en: 'Date started praying regularly' },
        'qada_menstrual_avg': { ar: 'متوسط أيام الدورة الشهرية', en: 'Average menstrual days per cycle' },
        'qada_additional_q': { ar: 'هل فاتتك صلوات إضافية بعد الانتظام؟', en: 'Did you miss additional prayers after becoming regular?' },
        'qada_yes': { ar: 'نعم', en: 'Yes' },
        'qada_no': { ar: 'لا', en: 'No' },
        'qada_add_period': { ar: 'إضافة فترة', en: 'Add Period' },
        'qada_type_specific': { ar: 'صلاة معينة لفترة', en: 'Specific prayer for a period' },
        'qada_type_all': { ar: 'كل الصلوات لفترة', en: 'All prayers for a period' },
        'qada_type_estimate': { ar: 'عدد تقديري', en: 'Estimated number' },
        'qada_from_date': { ar: 'من تاريخ', en: 'From date' },
        'qada_to_date': { ar: 'إلى تاريخ', en: 'To date' },
        'qada_select_prayer': { ar: 'اختر الصلاة', en: 'Select prayer' },
        'qada_all_prayers': { ar: 'كل الصلوات', en: 'All prayers' },
        'qada_estimated_num': { ar: 'العدد التقديري', en: 'Estimated number' },
        'qada_period_days': { ar: 'يوم', en: 'days' },
        'qada_period_prayers': { ar: 'صلاة', en: 'prayers' },
        'qada_running_total': { ar: 'الإجمالي الكلي', en: 'Total' },
        'qada_next': { ar: 'التالي', en: 'Next' },
        'qada_back': { ar: 'رجوع', en: 'Back' },
        'qada_breakdown': { ar: 'تفصيل الصلوات', en: 'Prayer Breakdown' },
        'qada_daily_target': { ar: 'كم صلاة قضاء تريد أن تصلي يومياً؟', en: 'How many qada prayers per day?' },
        'qada_1_per': { ar: '١ مع كل صلاة', en: '1 with each prayer' },
        'qada_2_per': { ar: '٢ مع كل صلاة', en: '2 with each prayer' },
        'qada_3_per': { ar: '٣ مع كل صلاة', en: '3 with each prayer' },
        'qada_custom': { ar: 'عدد مخصص', en: 'Custom number' },
        'qada_expected_duration': { ar: 'المدة المتوقعة', en: 'Expected duration' },
        'qada_expected_end': { ar: 'تاريخ الانتهاء المتوقع', en: 'Expected completion date' },
        'qada_daily_count': { ar: 'عدد الصلوات اليومية', en: 'Daily prayer count' },
        'qada_years': { ar: 'سنة', en: 'years' },
        'qada_months': { ar: 'شهر', en: 'months' },
        'qada_and': { ar: 'و', en: 'and' },
        'qada_start_plan': { ar: 'ابدأ الخطة', en: 'Start Plan' },
        ...
        'qada_total': { ar: 'الإجمالي', en: 'Total' },
        'qada_completed': { ar: 'تم إنجازه', en: 'Completed' },
        'qada_remaining': { ar: 'المتبقي', en: 'Remaining' },
        'qada_fill_dates': { ar: 'يرجى إدخال التاريخين', en: 'Please enter both dates' },
        'qada_invalid_dates': { ar: 'تاريخ البلوغ يجب أن يكون قبل تاريخ الانتظام', en: 'Puberty date must be before regular prayer date' },
