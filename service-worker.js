// Prayer Tracker PWA — Service Worker v213
const CACHE_NAME = 'salah-tracker-v213';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=213',
    './css/themes.css?v=213',
    './css/dashboard.css?v=213',
    './css/splash.css?v=213',
    // JS modules (dependency order)
    './js/config.js?v=213',
    './js/storage.js?v=213',
    './js/hijri-calendar.js?v=213',
    './js/ui-utils.js?v=213',
    './js/i18n.js?v=213',
    './js/themes.js?v=213',
    './js/profiles.js?v=213',
    './js/female-features.js?v=213',
    './js/fard-tracker.js?v=213',
    './js/sunnah-tracker.js?v=213',
    './js/jamaah-tracker.js?v=213',
    './js/weekly-view.js?v=213',
    './js/fasting-tracker.js?v=213',
    './js/prayer-times.js?v=213',
    './js/notifications.js?v=213',
    './js/azkar-tracker.js?v=213',
    './js/svg-charts.js?v=213',
    './js/info-tooltips.js?v=213',
    './js/qada-report.js?v=213',
    './js/qada-calculator.js?v=213',
    './js/qada-tracker.js?v=213',
    './js/qada-dashboard.js?v=213',
    './js/dashboard.js?v=213',
    './js/year-overview.js?v=213',
    './js/data-io.js?v=213',
