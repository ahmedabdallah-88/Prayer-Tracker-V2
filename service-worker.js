// Prayer Tracker PWA — Service Worker v256
const CACHE_NAME = 'salah-tracker-v256';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=256',
    './css/themes.css?v=256',
    './css/dashboard.css?v=256',
    './css/splash.css?v=256',
    // JS modules (dependency order)
    './js/config.js?v=256',
    './js/storage.js?v=256',
    './js/hijri-calendar.js?v=256',
    './js/ui-utils.js?v=256',
    './js/i18n.js?v=256',
    './js/themes.js?v=256',
    './js/profiles.js?v=256',
    './js/female-features.js?v=256',
    './js/fard-tracker.js?v=256',
    './js/sunnah-tracker.js?v=256',
    './js/jamaah-tracker.js?v=256',
    './js/prayer-streaks.js?v=256',
    './js/weekly-view.js?v=256',
    './js/fasting-tracker.js?v=256',
    './js/prayer-times.js?v=256',
    './js/notifications.js?v=256',
    './js/azkar-tracker.js?v=256',
    './js/svg-charts.js?v=256',
    './js/info-tooltips.js?v=256',
    './js/qada-report.js?v=256',
    './js/qada-calculator.js?v=256',
    './js/qada-tracker.js?v=256',
    './js/qada-dashboard.js?v=256',
    './js/dashboard.js?v=256',
    './js/year-overview.js?v=256',
    './js/data-io.js?v=256',
    './js/onboarding.js?v=256',
    './js/app.js?v=256',
    // Icons
