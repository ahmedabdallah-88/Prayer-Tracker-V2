// Prayer Tracker PWA — Service Worker v281
const CACHE_NAME = 'salah-tracker-v281';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=281',
    './css/themes.css?v=281',
    './css/dashboard.css?v=281',
    './css/splash.css?v=281',
    // JS modules (dependency order)
    './js/config.js?v=281',
    './js/storage.js?v=281',
    './js/hijri-calendar.js?v=281',
    './js/ui-utils.js?v=281',
    './js/i18n.js?v=281',
    './js/themes.js?v=281',
    './js/profiles.js?v=281',
    './js/female-features.js?v=281',
    './js/fard-tracker.js?v=281',
    './js/sunnah-tracker.js?v=281',
    './js/jamaah-tracker.js?v=281',
    './js/prayer-streaks.js?v=281',
    './js/weekly-view.js?v=281',
    './js/fasting-tracker.js?v=281',
    './js/prayer-times.js?v=281',
    './js/notifications.js?v=281',
    './js/azkar-tracker.js?v=281',
    './js/svg-charts.js?v=281',
    './js/info-tooltips.js?v=281',
    './js/qada-report.js?v=281',
    './js/qada-calculator.js?v=281',
    './js/qada-tracker.js?v=281',
    './js/qada-dashboard.js?v=281',
    './js/dashboard.js?v=281',
    './js/year-overview.js?v=281',
    './js/data-io.js?v=281',
    './js/onboarding.js?v=281',
    './js/app.js?v=281',
    // Icons
