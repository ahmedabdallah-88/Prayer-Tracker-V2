// Prayer Tracker PWA — Service Worker v248
const CACHE_NAME = 'salah-tracker-v248';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=248',
    './css/themes.css?v=248',
    './css/dashboard.css?v=248',
    './css/splash.css?v=248',
    // JS modules (dependency order)
    './js/config.js?v=248',
    './js/storage.js?v=248',
    './js/hijri-calendar.js?v=248',
    './js/ui-utils.js?v=248',
    './js/i18n.js?v=248',
    './js/themes.js?v=248',
    './js/profiles.js?v=248',
    './js/female-features.js?v=248',
    './js/fard-tracker.js?v=248',
    './js/sunnah-tracker.js?v=248',
    './js/jamaah-tracker.js?v=248',
    './js/weekly-view.js?v=248',
    './js/fasting-tracker.js?v=248',
    './js/prayer-times.js?v=248',
    './js/notifications.js?v=248',
    './js/azkar-tracker.js?v=248',
    './js/svg-charts.js?v=248',
    './js/info-tooltips.js?v=248',
    './js/qada-report.js?v=248',
    './js/qada-calculator.js?v=248',
    './js/qada-tracker.js?v=248',
    './js/qada-dashboard.js?v=248',
    './js/dashboard.js?v=248',
    './js/year-overview.js?v=248',
    './js/data-io.js?v=248',
    './js/onboarding.js?v=248',
    './js/app.js?v=248',
    // Icons
