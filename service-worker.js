// Prayer Tracker PWA — Service Worker v268
const CACHE_NAME = 'salah-tracker-v268';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=268',
    './css/themes.css?v=268',
    './css/dashboard.css?v=268',
    './css/splash.css?v=268',
    // JS modules (dependency order)
    './js/config.js?v=268',
    './js/storage.js?v=268',
    './js/hijri-calendar.js?v=268',
    './js/ui-utils.js?v=268',
    './js/i18n.js?v=268',
    './js/themes.js?v=268',
    './js/profiles.js?v=268',
    './js/female-features.js?v=268',
    './js/fard-tracker.js?v=268',
    './js/sunnah-tracker.js?v=268',
    './js/jamaah-tracker.js?v=268',
    './js/prayer-streaks.js?v=268',
    './js/weekly-view.js?v=268',
    './js/fasting-tracker.js?v=268',
    './js/prayer-times.js?v=268',
    './js/notifications.js?v=268',
    './js/azkar-tracker.js?v=268',
    './js/svg-charts.js?v=268',
    './js/info-tooltips.js?v=268',
    './js/qada-report.js?v=268',
    './js/qada-calculator.js?v=268',
    './js/qada-tracker.js?v=268',
    './js/qada-dashboard.js?v=268',
    './js/dashboard.js?v=268',
    './js/year-overview.js?v=268',
    './js/data-io.js?v=268',
    './js/onboarding.js?v=268',
    './js/app.js?v=268',
    // Icons
