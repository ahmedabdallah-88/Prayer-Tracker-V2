// Prayer Tracker PWA — Service Worker v206
const CACHE_NAME = 'salah-tracker-v206';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=206',
    './css/themes.css?v=206',
    './css/dashboard.css?v=206',
    './css/splash.css?v=206',
    // JS modules (dependency order)
    './js/config.js?v=206',
    './js/storage.js?v=206',
    './js/hijri-calendar.js?v=206',
    './js/ui-utils.js?v=206',
    './js/i18n.js?v=206',
    './js/themes.js?v=206',
    './js/profiles.js?v=206',
    './js/female-features.js?v=206',
    './js/fard-tracker.js?v=206',
    './js/sunnah-tracker.js?v=206',
    './js/jamaah-tracker.js?v=206',
    './js/weekly-view.js?v=206',
    './js/fasting-tracker.js?v=206',
    './js/prayer-times.js?v=206',
    './js/notifications.js?v=206',
    './js/azkar-tracker.js?v=206',
    './js/svg-charts.js?v=206',
    './js/info-tooltips.js?v=206',
    './js/qada-report.js?v=206',
    './js/qada-calculator.js?v=206',
    './js/dashboard.js?v=206',
    './js/year-overview.js?v=206',
    './js/data-io.js?v=206',
    './js/onboarding.js?v=206',
    './js/app.js?v=206',
    // Icons
