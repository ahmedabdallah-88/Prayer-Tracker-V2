// Prayer Tracker PWA — Service Worker v266
const CACHE_NAME = 'salah-tracker-v266';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=266',
    './css/themes.css?v=266',
    './css/dashboard.css?v=266',
    './css/splash.css?v=266',
    // JS modules (dependency order)
    './js/config.js?v=266',
    './js/storage.js?v=266',
    './js/hijri-calendar.js?v=266',
    './js/ui-utils.js?v=266',
    './js/i18n.js?v=266',
    './js/themes.js?v=266',
    './js/profiles.js?v=266',
    './js/female-features.js?v=266',
    './js/fard-tracker.js?v=266',
    './js/sunnah-tracker.js?v=266',
    './js/jamaah-tracker.js?v=266',
    './js/prayer-streaks.js?v=266',
    './js/weekly-view.js?v=266',
    './js/fasting-tracker.js?v=266',
    './js/prayer-times.js?v=266',
    './js/notifications.js?v=266',
    './js/azkar-tracker.js?v=266',
    './js/svg-charts.js?v=266',
    './js/info-tooltips.js?v=266',
    './js/qada-report.js?v=266',
    './js/qada-calculator.js?v=266',
    './js/qada-tracker.js?v=266',
    './js/qada-dashboard.js?v=266',
    './js/dashboard.js?v=266',
    './js/year-overview.js?v=266',
    './js/data-io.js?v=266',
    './js/onboarding.js?v=266',
    './js/app.js?v=266',
    // Icons
