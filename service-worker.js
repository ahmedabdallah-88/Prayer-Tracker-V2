// Prayer Tracker PWA — Service Worker v247
const CACHE_NAME = 'salah-tracker-v247';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=247',
    './css/themes.css?v=247',
    './css/dashboard.css?v=247',
    './css/splash.css?v=247',
    // JS modules (dependency order)
    './js/config.js?v=247',
    './js/storage.js?v=247',
    './js/hijri-calendar.js?v=247',
    './js/ui-utils.js?v=247',
    './js/i18n.js?v=247',
    './js/themes.js?v=247',
    './js/profiles.js?v=247',
    './js/female-features.js?v=247',
    './js/fard-tracker.js?v=247',
    './js/sunnah-tracker.js?v=247',
    './js/jamaah-tracker.js?v=247',
    './js/weekly-view.js?v=247',
    './js/fasting-tracker.js?v=247',
    './js/prayer-times.js?v=247',
    './js/notifications.js?v=247',
    './js/azkar-tracker.js?v=247',
    './js/svg-charts.js?v=247',
    './js/info-tooltips.js?v=247',
    './js/qada-report.js?v=247',
    './js/qada-calculator.js?v=247',
    './js/qada-tracker.js?v=247',
    './js/qada-dashboard.js?v=247',
    './js/dashboard.js?v=247',
    './js/year-overview.js?v=247',
    './js/data-io.js?v=247',
    './js/onboarding.js?v=247',
    './js/app.js?v=247',
    // Icons
