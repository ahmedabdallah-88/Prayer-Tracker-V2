// Prayer Tracker PWA — Service Worker v205
const CACHE_NAME = 'salah-tracker-v205';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=205',
    './css/themes.css?v=205',
    './css/dashboard.css?v=205',
    './css/splash.css?v=205',
    // JS modules (dependency order)
    './js/config.js?v=205',
    './js/storage.js?v=205',
    './js/hijri-calendar.js?v=205',
    './js/ui-utils.js?v=205',
    './js/i18n.js?v=205',
    './js/themes.js?v=205',
    './js/profiles.js?v=205',
    './js/female-features.js?v=205',
    './js/fard-tracker.js?v=205',
    './js/sunnah-tracker.js?v=205',
    './js/jamaah-tracker.js?v=205',
    './js/weekly-view.js?v=205',
    './js/fasting-tracker.js?v=205',
    './js/prayer-times.js?v=205',
    './js/notifications.js?v=205',
    './js/azkar-tracker.js?v=205',
    './js/svg-charts.js?v=205',
    './js/info-tooltips.js?v=205',
    './js/qada-report.js?v=205',
    './js/qada-calculator.js?v=205',
    './js/dashboard.js?v=205',
    './js/year-overview.js?v=205',
    './js/data-io.js?v=205',
    './js/onboarding.js?v=205',
    './js/app.js?v=205',
    // Icons
