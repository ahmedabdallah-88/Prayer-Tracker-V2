// Prayer Tracker PWA — Service Worker v265
const CACHE_NAME = 'salah-tracker-v265';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=265',
    './css/themes.css?v=265',
    './css/dashboard.css?v=265',
    './css/splash.css?v=265',
    // JS modules (dependency order)
    './js/config.js?v=265',
    './js/storage.js?v=265',
    './js/hijri-calendar.js?v=265',
    './js/ui-utils.js?v=265',
    './js/i18n.js?v=265',
    './js/themes.js?v=265',
    './js/profiles.js?v=265',
    './js/female-features.js?v=265',
    './js/fard-tracker.js?v=265',
    './js/sunnah-tracker.js?v=265',
    './js/jamaah-tracker.js?v=265',
    './js/prayer-streaks.js?v=265',
    './js/weekly-view.js?v=265',
    './js/fasting-tracker.js?v=265',
    './js/prayer-times.js?v=265',
    './js/notifications.js?v=265',
    './js/azkar-tracker.js?v=265',
    './js/svg-charts.js?v=265',
    './js/info-tooltips.js?v=265',
    './js/qada-report.js?v=265',
    './js/qada-calculator.js?v=265',
    './js/qada-tracker.js?v=265',
    './js/qada-dashboard.js?v=265',
    './js/dashboard.js?v=265',
    './js/year-overview.js?v=265',
    './js/data-io.js?v=265',
    './js/onboarding.js?v=265',
    './js/app.js?v=265',
    // Icons
