// Prayer Tracker PWA — Service Worker v244
const CACHE_NAME = 'salah-tracker-v244';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=244',
    './css/themes.css?v=244',
    './css/dashboard.css?v=244',
    './css/splash.css?v=244',
    // JS modules (dependency order)
    './js/config.js?v=244',
    './js/storage.js?v=244',
    './js/hijri-calendar.js?v=244',
    './js/ui-utils.js?v=244',
    './js/i18n.js?v=244',
    './js/themes.js?v=244',
    './js/profiles.js?v=244',
    './js/female-features.js?v=244',
    './js/fard-tracker.js?v=244',
    './js/sunnah-tracker.js?v=244',
    './js/jamaah-tracker.js?v=244',
    './js/weekly-view.js?v=244',
    './js/fasting-tracker.js?v=244',
    './js/prayer-times.js?v=244',
    './js/notifications.js?v=244',
    './js/azkar-tracker.js?v=244',
    './js/svg-charts.js?v=244',
    './js/info-tooltips.js?v=244',
    './js/qada-report.js?v=244',
    './js/qada-calculator.js?v=244',
    './js/qada-tracker.js?v=244',
    './js/qada-dashboard.js?v=244',
    './js/dashboard.js?v=244',
    './js/year-overview.js?v=244',
    './js/data-io.js?v=244',
    './js/onboarding.js?v=244',
    './js/app.js?v=244',
    // Icons
