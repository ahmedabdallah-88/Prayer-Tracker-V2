// Prayer Tracker PWA — Service Worker v270
const CACHE_NAME = 'salah-tracker-v270';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=270',
    './css/themes.css?v=270',
    './css/dashboard.css?v=270',
    './css/splash.css?v=270',
    // JS modules (dependency order)
    './js/config.js?v=270',
    './js/storage.js?v=270',
    './js/hijri-calendar.js?v=270',
    './js/ui-utils.js?v=270',
    './js/i18n.js?v=270',
    './js/themes.js?v=270',
    './js/profiles.js?v=270',
    './js/female-features.js?v=270',
    './js/fard-tracker.js?v=270',
    './js/sunnah-tracker.js?v=270',
    './js/jamaah-tracker.js?v=270',
    './js/prayer-streaks.js?v=270',
    './js/weekly-view.js?v=270',
    './js/fasting-tracker.js?v=270',
    './js/prayer-times.js?v=270',
    './js/notifications.js?v=270',
    './js/azkar-tracker.js?v=270',
    './js/svg-charts.js?v=270',
    './js/info-tooltips.js?v=270',
    './js/qada-report.js?v=270',
    './js/qada-calculator.js?v=270',
    './js/qada-tracker.js?v=270',
    './js/qada-dashboard.js?v=270',
    './js/dashboard.js?v=270',
    './js/year-overview.js?v=270',
    './js/data-io.js?v=270',
    './js/onboarding.js?v=270',
    './js/app.js?v=270',
    // Icons
