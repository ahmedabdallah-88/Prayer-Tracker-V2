// Prayer Tracker PWA — Service Worker v207
const CACHE_NAME = 'salah-tracker-v207';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=207',
    './css/themes.css?v=207',
    './css/dashboard.css?v=207',
    './css/splash.css?v=207',
    // JS modules (dependency order)
    './js/config.js?v=207',
    './js/storage.js?v=207',
    './js/hijri-calendar.js?v=207',
    './js/ui-utils.js?v=207',
    './js/i18n.js?v=207',
    './js/themes.js?v=207',
    './js/profiles.js?v=207',
    './js/female-features.js?v=207',
    './js/fard-tracker.js?v=207',
    './js/sunnah-tracker.js?v=207',
    './js/jamaah-tracker.js?v=207',
    './js/weekly-view.js?v=207',
    './js/fasting-tracker.js?v=207',
    './js/prayer-times.js?v=207',
    './js/notifications.js?v=207',
    './js/azkar-tracker.js?v=207',
    './js/svg-charts.js?v=207',
    './js/info-tooltips.js?v=207',
    './js/qada-report.js?v=207',
    './js/qada-calculator.js?v=207',
    './js/dashboard.js?v=207',
    './js/year-overview.js?v=207',
    './js/data-io.js?v=207',
    './js/onboarding.js?v=207',
    './js/app.js?v=207',
    // Icons
