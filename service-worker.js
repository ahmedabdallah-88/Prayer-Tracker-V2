// Prayer Tracker PWA — Service Worker v249
const CACHE_NAME = 'salah-tracker-v249';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=249',
    './css/themes.css?v=249',
    './css/dashboard.css?v=249',
    './css/splash.css?v=249',
    // JS modules (dependency order)
    './js/config.js?v=249',
    './js/storage.js?v=249',
    './js/hijri-calendar.js?v=249',
    './js/ui-utils.js?v=249',
    './js/i18n.js?v=249',
    './js/themes.js?v=249',
    './js/profiles.js?v=249',
    './js/female-features.js?v=249',
    './js/fard-tracker.js?v=249',
    './js/sunnah-tracker.js?v=249',
    './js/jamaah-tracker.js?v=249',
    './js/prayer-streaks.js?v=249',
    './js/weekly-view.js?v=249',
    './js/fasting-tracker.js?v=249',
    './js/prayer-times.js?v=249',
    './js/notifications.js?v=249',
    './js/azkar-tracker.js?v=249',
    './js/svg-charts.js?v=249',
    './js/info-tooltips.js?v=249',
    './js/qada-report.js?v=249',
    './js/qada-calculator.js?v=249',
    './js/qada-tracker.js?v=249',
    './js/qada-dashboard.js?v=249',
    './js/dashboard.js?v=249',
    './js/year-overview.js?v=249',
    './js/data-io.js?v=249',
    './js/onboarding.js?v=249',
    './js/app.js?v=249',
    // Icons
