// Prayer Tracker PWA — Service Worker v264
const CACHE_NAME = 'salah-tracker-v264';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=262',
    './css/themes.css?v=262',
    './css/dashboard.css?v=262',
    './css/splash.css?v=262',
    // JS modules (dependency order)
    './js/config.js?v=262',
    './js/storage.js?v=262',
    './js/hijri-calendar.js?v=262',
    './js/ui-utils.js?v=262',
    './js/i18n.js?v=262',
    './js/themes.js?v=262',
    './js/profiles.js?v=262',
    './js/female-features.js?v=262',
    './js/fard-tracker.js?v=262',
    './js/sunnah-tracker.js?v=262',
    './js/jamaah-tracker.js?v=262',
    './js/prayer-streaks.js?v=262',
    './js/weekly-view.js?v=262',
    './js/fasting-tracker.js?v=262',
    './js/prayer-times.js?v=262',
    './js/notifications.js?v=262',
    './js/azkar-tracker.js?v=262',
    './js/svg-charts.js?v=262',
    './js/info-tooltips.js?v=262',
    './js/qada-report.js?v=262',
    './js/qada-calculator.js?v=262',
    './js/qada-tracker.js?v=262',
    './js/qada-dashboard.js?v=262',
    './js/dashboard.js?v=262',
    './js/year-overview.js?v=262',
    './js/data-io.js?v=262',
    './js/onboarding.js?v=262',
    './js/app.js?v=262',
    // Icons
