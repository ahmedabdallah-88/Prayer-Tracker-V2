// Prayer Tracker PWA — Service Worker v280
const CACHE_NAME = 'salah-tracker-v280';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=280',
    './css/themes.css?v=280',
    './css/dashboard.css?v=280',
    './css/splash.css?v=280',
    // JS modules (dependency order)
    './js/config.js?v=280',
    './js/storage.js?v=280',
    './js/hijri-calendar.js?v=280',
    './js/ui-utils.js?v=280',
    './js/i18n.js?v=280',
    './js/themes.js?v=280',
    './js/profiles.js?v=280',
    './js/female-features.js?v=280',
    './js/fard-tracker.js?v=280',
    './js/sunnah-tracker.js?v=280',
    './js/jamaah-tracker.js?v=280',
    './js/prayer-streaks.js?v=280',
    './js/weekly-view.js?v=280',
    './js/fasting-tracker.js?v=280',
    './js/prayer-times.js?v=280',
    './js/notifications.js?v=280',
    './js/azkar-tracker.js?v=280',
    './js/svg-charts.js?v=280',
    './js/info-tooltips.js?v=280',
    './js/qada-report.js?v=280',
    './js/qada-calculator.js?v=280',
    './js/qada-tracker.js?v=280',
    './js/qada-dashboard.js?v=280',
    './js/dashboard.js?v=280',
    './js/year-overview.js?v=280',
    './js/data-io.js?v=280',
    './js/onboarding.js?v=280',
    './js/app.js?v=280',
    // Icons
