// Prayer Tracker PWA — Service Worker v282
const CACHE_NAME = 'salah-tracker-v282';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=282',
    './css/themes.css?v=282',
    './css/dashboard.css?v=282',
    './css/splash.css?v=282',
    // JS modules (dependency order)
    './js/config.js?v=282',
    './js/storage.js?v=282',
    './js/hijri-calendar.js?v=282',
    './js/ui-utils.js?v=282',
    './js/i18n.js?v=282',
    './js/themes.js?v=282',
    './js/profiles.js?v=282',
    './js/female-features.js?v=282',
    './js/fard-tracker.js?v=282',
    './js/sunnah-tracker.js?v=282',
    './js/jamaah-tracker.js?v=282',
    './js/prayer-streaks.js?v=282',
    './js/weekly-view.js?v=282',
    './js/fasting-tracker.js?v=282',
    './js/prayer-times.js?v=282',
    './js/notifications.js?v=282',
    './js/azkar-tracker.js?v=282',
    './js/svg-charts.js?v=282',
    './js/info-tooltips.js?v=282',
    './js/qada-report.js?v=282',
    './js/qada-calculator.js?v=282',
    './js/qada-tracker.js?v=282',
    './js/qada-dashboard.js?v=282',
    './js/dashboard.js?v=282',
    './js/year-overview.js?v=282',
    './js/data-io.js?v=282',
    './js/onboarding.js?v=282',
    './js/app.js?v=282',
    // Icons
