// Prayer Tracker PWA — Service Worker v252
const CACHE_NAME = 'salah-tracker-v252';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=252',
    './css/themes.css?v=252',
    './css/dashboard.css?v=252',
    './css/splash.css?v=252',
    // JS modules (dependency order)
    './js/config.js?v=252',
    './js/storage.js?v=252',
    './js/hijri-calendar.js?v=252',
    './js/ui-utils.js?v=252',
    './js/i18n.js?v=252',
    './js/themes.js?v=252',
    './js/profiles.js?v=252',
    './js/female-features.js?v=252',
    './js/fard-tracker.js?v=252',
    './js/sunnah-tracker.js?v=252',
    './js/jamaah-tracker.js?v=252',
    './js/prayer-streaks.js?v=252',
    './js/weekly-view.js?v=252',
    './js/fasting-tracker.js?v=252',
    './js/prayer-times.js?v=252',
    './js/notifications.js?v=252',
    './js/azkar-tracker.js?v=252',
    './js/svg-charts.js?v=252',
    './js/info-tooltips.js?v=252',
    './js/qada-report.js?v=252',
    './js/qada-calculator.js?v=252',
    './js/qada-tracker.js?v=252',
    './js/qada-dashboard.js?v=252',
    './js/dashboard.js?v=252',
    './js/year-overview.js?v=252',
    './js/data-io.js?v=252',
    './js/onboarding.js?v=252',
    './js/app.js?v=252',
    // Icons
