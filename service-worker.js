// Prayer Tracker PWA — Service Worker v209
const CACHE_NAME = 'salah-tracker-v209';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=209',
    './css/themes.css?v=209',
    './css/dashboard.css?v=209',
    './css/splash.css?v=209',
    // JS modules (dependency order)
    './js/config.js?v=209',
    './js/storage.js?v=209',
    './js/hijri-calendar.js?v=209',
    './js/ui-utils.js?v=209',
    './js/i18n.js?v=209',
    './js/themes.js?v=209',
    './js/profiles.js?v=209',
    './js/female-features.js?v=209',
    './js/fard-tracker.js?v=209',
    './js/sunnah-tracker.js?v=209',
    './js/jamaah-tracker.js?v=209',
    './js/weekly-view.js?v=209',
    './js/fasting-tracker.js?v=209',
    './js/prayer-times.js?v=209',
    './js/notifications.js?v=209',
    './js/azkar-tracker.js?v=209',
    './js/svg-charts.js?v=209',
    './js/info-tooltips.js?v=209',
    './js/qada-report.js?v=209',
    './js/qada-calculator.js?v=209',
    './js/qada-tracker.js?v=209',
    './js/dashboard.js?v=209',
    './js/year-overview.js?v=209',
    './js/data-io.js?v=209',
