// Prayer Tracker PWA — Service Worker v254
const CACHE_NAME = 'salah-tracker-v254';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=254',
    './css/themes.css?v=254',
    './css/dashboard.css?v=254',
    './css/splash.css?v=254',
    // JS modules (dependency order)
    './js/config.js?v=254',
    './js/storage.js?v=254',
    './js/hijri-calendar.js?v=254',
    './js/ui-utils.js?v=254',
    './js/i18n.js?v=254',
    './js/themes.js?v=254',
    './js/profiles.js?v=254',
    './js/female-features.js?v=254',
    './js/fard-tracker.js?v=254',
    './js/sunnah-tracker.js?v=254',
    './js/jamaah-tracker.js?v=254',
    './js/prayer-streaks.js?v=254',
    './js/weekly-view.js?v=254',
    './js/fasting-tracker.js?v=254',
    './js/prayer-times.js?v=254',
    './js/notifications.js?v=254',
    './js/azkar-tracker.js?v=254',
    './js/svg-charts.js?v=254',
    './js/info-tooltips.js?v=254',
    './js/qada-report.js?v=254',
    './js/qada-calculator.js?v=254',
    './js/qada-tracker.js?v=254',
    './js/qada-dashboard.js?v=254',
    './js/dashboard.js?v=254',
    './js/year-overview.js?v=254',
    './js/data-io.js?v=254',
    './js/onboarding.js?v=254',
    './js/app.js?v=254',
    // Icons
