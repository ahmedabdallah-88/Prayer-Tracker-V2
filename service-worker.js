// Prayer Tracker PWA — Service Worker v211
const CACHE_NAME = 'salah-tracker-v211';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=211',
    './css/themes.css?v=211',
    './css/dashboard.css?v=211',
    './css/splash.css?v=211',
    // JS modules (dependency order)
    './js/config.js?v=211',
    './js/storage.js?v=211',
    './js/hijri-calendar.js?v=211',
    './js/ui-utils.js?v=211',
    './js/i18n.js?v=211',
    './js/themes.js?v=211',
    './js/profiles.js?v=211',
    './js/female-features.js?v=211',
    './js/fard-tracker.js?v=211',
    './js/sunnah-tracker.js?v=211',
    './js/jamaah-tracker.js?v=211',
    './js/weekly-view.js?v=211',
    './js/fasting-tracker.js?v=211',
    './js/prayer-times.js?v=211',
    './js/notifications.js?v=211',
    './js/azkar-tracker.js?v=211',
    './js/svg-charts.js?v=211',
    './js/info-tooltips.js?v=211',
    './js/qada-report.js?v=211',
    './js/qada-calculator.js?v=211',
    './js/qada-tracker.js?v=211',
    './js/qada-dashboard.js?v=211',
    './js/dashboard.js?v=211',
    './js/year-overview.js?v=211',
    './js/data-io.js?v=211',
