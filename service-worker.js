// Prayer Tracker PWA — Service Worker v258
const CACHE_NAME = 'salah-tracker-v258';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=257',
    './css/themes.css?v=257',
    './css/dashboard.css?v=257',
    './css/splash.css?v=257',
    // JS modules (dependency order)
    './js/config.js?v=257',
    './js/storage.js?v=257',
    './js/hijri-calendar.js?v=257',
    './js/ui-utils.js?v=257',
    './js/i18n.js?v=257',
    './js/themes.js?v=257',
    './js/profiles.js?v=257',
    './js/female-features.js?v=257',
    './js/fard-tracker.js?v=257',
    './js/sunnah-tracker.js?v=257',
    './js/jamaah-tracker.js?v=257',
    './js/prayer-streaks.js?v=257',
    './js/weekly-view.js?v=257',
    './js/fasting-tracker.js?v=257',
    './js/prayer-times.js?v=257',
    './js/notifications.js?v=257',
    './js/azkar-tracker.js?v=257',
    './js/svg-charts.js?v=257',
    './js/info-tooltips.js?v=257',
    './js/qada-report.js?v=257',
    './js/qada-calculator.js?v=257',
    './js/qada-tracker.js?v=257',
    './js/qada-dashboard.js?v=257',
    './js/dashboard.js?v=257',
    './js/year-overview.js?v=257',
    './js/data-io.js?v=257',
    './js/onboarding.js?v=257',
    './js/app.js?v=257',
    // Icons
