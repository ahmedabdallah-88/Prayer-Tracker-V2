// Prayer Tracker PWA — Service Worker v251
const CACHE_NAME = 'salah-tracker-v251';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=251',
    './css/themes.css?v=251',
    './css/dashboard.css?v=251',
    './css/splash.css?v=251',
    // JS modules (dependency order)
    './js/config.js?v=251',
    './js/storage.js?v=251',
    './js/hijri-calendar.js?v=251',
    './js/ui-utils.js?v=251',
    './js/i18n.js?v=251',
    './js/themes.js?v=251',
    './js/profiles.js?v=251',
    './js/female-features.js?v=251',
    './js/fard-tracker.js?v=251',
    './js/sunnah-tracker.js?v=251',
    './js/jamaah-tracker.js?v=251',
    './js/prayer-streaks.js?v=251',
    './js/weekly-view.js?v=251',
    './js/fasting-tracker.js?v=251',
    './js/prayer-times.js?v=251',
    './js/notifications.js?v=251',
    './js/azkar-tracker.js?v=251',
    './js/svg-charts.js?v=251',
    './js/info-tooltips.js?v=251',
    './js/qada-report.js?v=251',
    './js/qada-calculator.js?v=251',
    './js/qada-tracker.js?v=251',
    './js/qada-dashboard.js?v=251',
    './js/dashboard.js?v=251',
    './js/year-overview.js?v=251',
    './js/data-io.js?v=251',
    './js/onboarding.js?v=251',
    './js/app.js?v=251',
    // Icons
