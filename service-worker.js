// Prayer Tracker PWA — Service Worker v212
const CACHE_NAME = 'salah-tracker-v212';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=212',
    './css/themes.css?v=212',
    './css/dashboard.css?v=212',
    './css/splash.css?v=212',
    // JS modules (dependency order)
    './js/config.js?v=212',
    './js/storage.js?v=212',
    './js/hijri-calendar.js?v=212',
    './js/ui-utils.js?v=212',
    './js/i18n.js?v=212',
    './js/themes.js?v=212',
    './js/profiles.js?v=212',
    './js/female-features.js?v=212',
    './js/fard-tracker.js?v=212',
    './js/sunnah-tracker.js?v=212',
    './js/jamaah-tracker.js?v=212',
    './js/weekly-view.js?v=212',
    './js/fasting-tracker.js?v=212',
    './js/prayer-times.js?v=212',
    './js/notifications.js?v=212',
    './js/azkar-tracker.js?v=212',
    './js/svg-charts.js?v=212',
    './js/info-tooltips.js?v=212',
    './js/qada-report.js?v=212',
    './js/qada-calculator.js?v=212',
    './js/qada-tracker.js?v=212',
    './js/qada-dashboard.js?v=212',
    './js/dashboard.js?v=212',
    './js/year-overview.js?v=212',
    './js/data-io.js?v=212',
