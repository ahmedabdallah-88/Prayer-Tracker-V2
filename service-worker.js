// Prayer Tracker PWA — Service Worker v222
const CACHE_NAME = 'salah-tracker-v222';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=222',
    './css/themes.css?v=222',
    './css/dashboard.css?v=222',
    './css/splash.css?v=222',
    // JS modules (dependency order)
    './js/config.js?v=222',
    './js/storage.js?v=222',
    './js/hijri-calendar.js?v=222',
    './js/ui-utils.js?v=222',
    './js/i18n.js?v=222',
    './js/themes.js?v=222',
    './js/profiles.js?v=222',
    './js/female-features.js?v=222',
    './js/fard-tracker.js?v=222',
    './js/sunnah-tracker.js?v=222',
    './js/jamaah-tracker.js?v=222',
    './js/weekly-view.js?v=222',
    './js/fasting-tracker.js?v=222',
    './js/prayer-times.js?v=222',
    './js/notifications.js?v=222',
    './js/azkar-tracker.js?v=222',
    './js/svg-charts.js?v=222',
    './js/info-tooltips.js?v=222',
    './js/qada-report.js?v=222',
    './js/qada-calculator.js?v=222',
    './js/qada-tracker.js?v=222',
    './js/qada-dashboard.js?v=222',
    './js/dashboard.js?v=222',
    './js/year-overview.js?v=222',
    './js/data-io.js?v=222',
    './js/onboarding.js?v=222',
    './js/app.js?v=222',
    // Icons
