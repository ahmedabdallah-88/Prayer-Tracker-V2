// Prayer Tracker PWA — Service Worker v253
const CACHE_NAME = 'salah-tracker-v253';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=253',
    './css/themes.css?v=253',
    './css/dashboard.css?v=253',
    './css/splash.css?v=253',
    // JS modules (dependency order)
    './js/config.js?v=253',
    './js/storage.js?v=253',
    './js/hijri-calendar.js?v=253',
    './js/ui-utils.js?v=253',
    './js/i18n.js?v=253',
    './js/themes.js?v=253',
    './js/profiles.js?v=253',
    './js/female-features.js?v=253',
    './js/fard-tracker.js?v=253',
    './js/sunnah-tracker.js?v=253',
    './js/jamaah-tracker.js?v=253',
    './js/prayer-streaks.js?v=253',
    './js/weekly-view.js?v=253',
    './js/fasting-tracker.js?v=253',
    './js/prayer-times.js?v=253',
    './js/notifications.js?v=253',
    './js/azkar-tracker.js?v=253',
    './js/svg-charts.js?v=253',
    './js/info-tooltips.js?v=253',
    './js/qada-report.js?v=253',
    './js/qada-calculator.js?v=253',
    './js/qada-tracker.js?v=253',
    './js/qada-dashboard.js?v=253',
    './js/dashboard.js?v=253',
    './js/year-overview.js?v=253',
    './js/data-io.js?v=253',
    './js/onboarding.js?v=253',
    './js/app.js?v=253',
    // Icons
