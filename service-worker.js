// Prayer Tracker PWA — Service Worker v267
const CACHE_NAME = 'salah-tracker-v267';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=267',
    './css/themes.css?v=267',
    './css/dashboard.css?v=267',
    './css/splash.css?v=267',
    // JS modules (dependency order)
    './js/config.js?v=267',
    './js/storage.js?v=267',
    './js/hijri-calendar.js?v=267',
    './js/ui-utils.js?v=267',
    './js/i18n.js?v=267',
    './js/themes.js?v=267',
    './js/profiles.js?v=267',
    './js/female-features.js?v=267',
    './js/fard-tracker.js?v=267',
    './js/sunnah-tracker.js?v=267',
    './js/jamaah-tracker.js?v=267',
    './js/prayer-streaks.js?v=267',
    './js/weekly-view.js?v=267',
    './js/fasting-tracker.js?v=267',
    './js/prayer-times.js?v=267',
    './js/notifications.js?v=267',
    './js/azkar-tracker.js?v=267',
    './js/svg-charts.js?v=267',
    './js/info-tooltips.js?v=267',
    './js/qada-report.js?v=267',
    './js/qada-calculator.js?v=267',
    './js/qada-tracker.js?v=267',
    './js/qada-dashboard.js?v=267',
    './js/dashboard.js?v=267',
    './js/year-overview.js?v=267',
    './js/data-io.js?v=267',
    './js/onboarding.js?v=267',
    './js/app.js?v=267',
    // Icons
