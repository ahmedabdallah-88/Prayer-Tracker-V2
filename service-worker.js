// Prayer Tracker PWA — Service Worker v210
const CACHE_NAME = 'salah-tracker-v210';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=210',
    './css/themes.css?v=210',
    './css/dashboard.css?v=210',
    './css/splash.css?v=210',
    // JS modules (dependency order)
    './js/config.js?v=210',
    './js/storage.js?v=210',
    './js/hijri-calendar.js?v=210',
    './js/ui-utils.js?v=210',
    './js/i18n.js?v=210',
    './js/themes.js?v=210',
    './js/profiles.js?v=210',
    './js/female-features.js?v=210',
    './js/fard-tracker.js?v=210',
    './js/sunnah-tracker.js?v=210',
    './js/jamaah-tracker.js?v=210',
    './js/weekly-view.js?v=210',
    './js/fasting-tracker.js?v=210',
    './js/prayer-times.js?v=210',
    './js/notifications.js?v=210',
    './js/azkar-tracker.js?v=210',
    './js/svg-charts.js?v=210',
    './js/info-tooltips.js?v=210',
    './js/qada-report.js?v=210',
    './js/qada-calculator.js?v=210',
    './js/qada-tracker.js?v=210',
    './js/qada-dashboard.js?v=210',
    './js/dashboard.js?v=210',
    './js/year-overview.js?v=210',
    './js/data-io.js?v=210',
