// Prayer Tracker PWA — Service Worker v214
const CACHE_NAME = 'salah-tracker-v214';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=214',
    './css/themes.css?v=214',
    './css/dashboard.css?v=214',
    './css/splash.css?v=214',
    // JS modules (dependency order)
    './js/config.js?v=214',
    './js/storage.js?v=214',
    './js/hijri-calendar.js?v=214',
    './js/ui-utils.js?v=214',
    './js/i18n.js?v=214',
    './js/themes.js?v=214',
    './js/profiles.js?v=214',
    './js/female-features.js?v=214',
    './js/fard-tracker.js?v=214',
    './js/sunnah-tracker.js?v=214',
    './js/jamaah-tracker.js?v=214',
    './js/weekly-view.js?v=214',
    './js/fasting-tracker.js?v=214',
    './js/prayer-times.js?v=214',
    './js/notifications.js?v=214',
    './js/azkar-tracker.js?v=214',
    './js/svg-charts.js?v=214',
    './js/info-tooltips.js?v=214',
    './js/qada-report.js?v=214',
    './js/qada-calculator.js?v=214',
    './js/qada-tracker.js?v=214',
    './js/qada-dashboard.js?v=214',
    './js/dashboard.js?v=214',
    './js/year-overview.js?v=214',
    './js/data-io.js?v=214',
