// Prayer Tracker PWA — Service Worker v255
const CACHE_NAME = 'salah-tracker-v255';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=255',
    './css/themes.css?v=255',
    './css/dashboard.css?v=255',
    './css/splash.css?v=255',
    // JS modules (dependency order)
    './js/config.js?v=255',
    './js/storage.js?v=255',
    './js/hijri-calendar.js?v=255',
    './js/ui-utils.js?v=255',
    './js/i18n.js?v=255',
    './js/themes.js?v=255',
    './js/profiles.js?v=255',
    './js/female-features.js?v=255',
    './js/fard-tracker.js?v=255',
    './js/sunnah-tracker.js?v=255',
    './js/jamaah-tracker.js?v=255',
    './js/prayer-streaks.js?v=255',
    './js/weekly-view.js?v=255',
    './js/fasting-tracker.js?v=255',
    './js/prayer-times.js?v=255',
    './js/notifications.js?v=255',
    './js/azkar-tracker.js?v=255',
    './js/svg-charts.js?v=255',
    './js/info-tooltips.js?v=255',
    './js/qada-report.js?v=255',
    './js/qada-calculator.js?v=255',
    './js/qada-tracker.js?v=255',
    './js/qada-dashboard.js?v=255',
    './js/dashboard.js?v=255',
    './js/year-overview.js?v=255',
    './js/data-io.js?v=255',
    './js/onboarding.js?v=255',
    './js/app.js?v=255',
    // Icons
