// Prayer Tracker PWA — Service Worker v250
const CACHE_NAME = 'salah-tracker-v250';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=250',
    './css/themes.css?v=250',
    './css/dashboard.css?v=250',
    './css/splash.css?v=250',
    // JS modules (dependency order)
    './js/config.js?v=250',
    './js/storage.js?v=250',
    './js/hijri-calendar.js?v=250',
    './js/ui-utils.js?v=250',
    './js/i18n.js?v=250',
    './js/themes.js?v=250',
    './js/profiles.js?v=250',
    './js/female-features.js?v=250',
    './js/fard-tracker.js?v=250',
    './js/sunnah-tracker.js?v=250',
    './js/jamaah-tracker.js?v=250',
    './js/prayer-streaks.js?v=250',
    './js/weekly-view.js?v=250',
    './js/fasting-tracker.js?v=250',
    './js/prayer-times.js?v=250',
    './js/notifications.js?v=250',
    './js/azkar-tracker.js?v=250',
    './js/svg-charts.js?v=250',
    './js/info-tooltips.js?v=250',
    './js/qada-report.js?v=250',
    './js/qada-calculator.js?v=250',
    './js/qada-tracker.js?v=250',
    './js/qada-dashboard.js?v=250',
    './js/dashboard.js?v=250',
    './js/year-overview.js?v=250',
    './js/data-io.js?v=250',
    './js/onboarding.js?v=250',
    './js/app.js?v=250',
    // Icons
