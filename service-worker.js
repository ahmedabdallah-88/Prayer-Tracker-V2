// Prayer Tracker PWA — Service Worker v246
const CACHE_NAME = 'salah-tracker-v246';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=245',
    './css/themes.css?v=245',
    './css/dashboard.css?v=245',
    './css/splash.css?v=245',
    // JS modules (dependency order)
    './js/config.js?v=245',
    './js/storage.js?v=245',
    './js/hijri-calendar.js?v=245',
    './js/ui-utils.js?v=245',
    './js/i18n.js?v=245',
    './js/themes.js?v=245',
    './js/profiles.js?v=245',
    './js/female-features.js?v=245',
    './js/fard-tracker.js?v=245',
    './js/sunnah-tracker.js?v=245',
    './js/jamaah-tracker.js?v=245',
    './js/weekly-view.js?v=245',
    './js/fasting-tracker.js?v=245',
    './js/prayer-times.js?v=245',
    './js/notifications.js?v=245',
    './js/azkar-tracker.js?v=245',
    './js/svg-charts.js?v=245',
    './js/info-tooltips.js?v=245',
    './js/qada-report.js?v=245',
    './js/qada-calculator.js?v=245',
    './js/qada-tracker.js?v=245',
    './js/qada-dashboard.js?v=245',
    './js/dashboard.js?v=245',
    './js/year-overview.js?v=245',
    './js/data-io.js?v=245',
    './js/onboarding.js?v=245',
    './js/app.js?v=245',
    // Icons
