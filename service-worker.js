// Prayer Tracker PWA — Service Worker v208
const CACHE_NAME = 'salah-tracker-v208';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=208',
    './css/themes.css?v=208',
    './css/dashboard.css?v=208',
    './css/splash.css?v=208',
    // JS modules (dependency order)
    './js/config.js?v=208',
    './js/storage.js?v=208',
    './js/hijri-calendar.js?v=208',
    './js/ui-utils.js?v=208',
    './js/i18n.js?v=208',
    './js/themes.js?v=208',
    './js/profiles.js?v=208',
    './js/female-features.js?v=208',
    './js/fard-tracker.js?v=208',
    './js/sunnah-tracker.js?v=208',
    './js/jamaah-tracker.js?v=208',
    './js/weekly-view.js?v=208',
    './js/fasting-tracker.js?v=208',
    './js/prayer-times.js?v=208',
    './js/notifications.js?v=208',
    './js/azkar-tracker.js?v=208',
    './js/svg-charts.js?v=208',
    './js/info-tooltips.js?v=208',
    './js/qada-report.js?v=208',
    './js/qada-calculator.js?v=208',
    './js/qada-tracker.js?v=208',
    './js/dashboard.js?v=208',
    './js/year-overview.js?v=208',
    './js/data-io.js?v=208',
    './js/onboarding.js?v=208',
    './js/app.js?v=208',
    // Icons
