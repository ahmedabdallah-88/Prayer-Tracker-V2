// Prayer Tracker PWA — Service Worker v278
const CACHE_NAME = 'salah-tracker-v278';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=278',
    './css/themes.css?v=278',
    './css/dashboard.css?v=278',
    './css/splash.css?v=278',
    // JS modules (dependency order)
    './js/config.js?v=278',
    './js/storage.js?v=278',
    './js/hijri-calendar.js?v=278',
    './js/ui-utils.js?v=278',
    './js/i18n.js?v=278',
    './js/themes.js?v=278',
    './js/profiles.js?v=278',
    './js/female-features.js?v=278',
    './js/fard-tracker.js?v=278',
    './js/sunnah-tracker.js?v=278',
    './js/jamaah-tracker.js?v=278',
    './js/prayer-streaks.js?v=278',
    './js/weekly-view.js?v=278',
    './js/fasting-tracker.js?v=278',
    './js/prayer-times.js?v=278',
    './js/notifications.js?v=278',
    './js/azkar-tracker.js?v=278',
    './js/svg-charts.js?v=278',
    './js/info-tooltips.js?v=278',
    './js/qada-report.js?v=278',
    './js/qada-calculator.js?v=278',
    './js/qada-tracker.js?v=278',
    './js/qada-dashboard.js?v=278',
    './js/dashboard.js?v=278',
    './js/year-overview.js?v=278',
    './js/data-io.js?v=278',
    './js/onboarding.js?v=278',
    './js/app.js?v=278',
    // Icons
