// Prayer Tracker PWA — Service Worker v283
const CACHE_NAME = 'salah-tracker-v283';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=283',
    './css/themes.css?v=283',
    './css/dashboard.css?v=283',
    './css/splash.css?v=283',
    // JS modules (dependency order)
    './js/config.js?v=283',
    './js/storage.js?v=283',
    './js/hijri-calendar.js?v=283',
    './js/ui-utils.js?v=283',
    './js/i18n.js?v=283',
    './js/themes.js?v=283',
    './js/profiles.js?v=283',
    './js/female-features.js?v=283',
    './js/fard-tracker.js?v=283',
    './js/sunnah-tracker.js?v=283',
    './js/jamaah-tracker.js?v=283',
    './js/prayer-streaks.js?v=283',
    './js/weekly-view.js?v=283',
    './js/fasting-tracker.js?v=283',
    './js/prayer-times.js?v=283',
    './js/notifications.js?v=283',
    './js/azkar-tracker.js?v=283',
    './js/svg-charts.js?v=283',
    './js/info-tooltips.js?v=283',
    './js/qada-report.js?v=283',
    './js/qada-calculator.js?v=283',
    './js/qada-tracker.js?v=283',
    './js/qada-dashboard.js?v=283',
    './js/dashboard.js?v=283',
    './js/year-overview.js?v=283',
    './js/data-io.js?v=283',
    './js/onboarding.js?v=283',
    './js/app.js?v=283',
    // Icons
