// Prayer Tracker PWA — Service Worker v279
const CACHE_NAME = 'salah-tracker-v279';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=279',
    './css/themes.css?v=279',
    './css/dashboard.css?v=279',
    './css/splash.css?v=279',
    // JS modules (dependency order)
    './js/config.js?v=279',
    './js/storage.js?v=279',
    './js/hijri-calendar.js?v=279',
    './js/ui-utils.js?v=279',
    './js/i18n.js?v=279',
    './js/themes.js?v=279',
    './js/profiles.js?v=279',
    './js/female-features.js?v=279',
    './js/fard-tracker.js?v=279',
    './js/sunnah-tracker.js?v=279',
    './js/jamaah-tracker.js?v=279',
    './js/prayer-streaks.js?v=279',
    './js/weekly-view.js?v=279',
    './js/fasting-tracker.js?v=279',
    './js/prayer-times.js?v=279',
    './js/notifications.js?v=279',
    './js/azkar-tracker.js?v=279',
    './js/svg-charts.js?v=279',
    './js/info-tooltips.js?v=279',
    './js/qada-report.js?v=279',
    './js/qada-calculator.js?v=279',
    './js/qada-tracker.js?v=279',
    './js/qada-dashboard.js?v=279',
    './js/dashboard.js?v=279',
    './js/year-overview.js?v=279',
    './js/data-io.js?v=279',
    './js/onboarding.js?v=279',
    './js/app.js?v=279',
    // Icons
