// Prayer Tracker PWA — Service Worker v271
const CACHE_NAME = 'salah-tracker-v271';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=271',
    './css/themes.css?v=271',
    './css/dashboard.css?v=271',
    './css/splash.css?v=271',
    // JS modules (dependency order)
    './js/config.js?v=271',
    './js/storage.js?v=271',
    './js/hijri-calendar.js?v=271',
    './js/ui-utils.js?v=271',
    './js/i18n.js?v=271',
    './js/themes.js?v=271',
    './js/profiles.js?v=271',
    './js/female-features.js?v=271',
    './js/fard-tracker.js?v=271',
    './js/sunnah-tracker.js?v=271',
    './js/jamaah-tracker.js?v=271',
    './js/prayer-streaks.js?v=271',
    './js/weekly-view.js?v=271',
    './js/fasting-tracker.js?v=271',
    './js/prayer-times.js?v=271',
    './js/notifications.js?v=271',
    './js/azkar-tracker.js?v=271',
    './js/svg-charts.js?v=271',
    './js/info-tooltips.js?v=271',
    './js/qada-report.js?v=271',
    './js/qada-calculator.js?v=271',
    './js/qada-tracker.js?v=271',
    './js/qada-dashboard.js?v=271',
    './js/dashboard.js?v=271',
    './js/year-overview.js?v=271',
    './js/data-io.js?v=271',
    './js/onboarding.js?v=271',
    './js/app.js?v=271',
    // Icons
